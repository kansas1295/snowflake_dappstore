...
import { isHydroIdAvailable } from "../../../services/utilities";

import hydroIdImg from "../../../common/img/steps/hydroId.png";

function HydroIdStep({ setNextStep, setHydroId }) {
  ...
  return (
    <div>
      ...
      <Row className="justify-content-center">
        <Col xs="12" sm="6" className="text-center">
          <h1 className="text-white">Hydro ID</h1>
        </Col>
      </Row>
      <Row className="justify-content-center py-3">
        <Col xs="12" sm="8" className="text-center">
          <p className="text-white">
            ...
            that will be linked to and identify your account while using any
            Hydro product. Think of it like a user ID. You can either make this
            up or use the ID assigned to you in the Hydro mobile app. We
            recommend using the mobile app as it empowers the entire Hydro
            ecosystem.
          </p>
        </Col>
      </Row>
