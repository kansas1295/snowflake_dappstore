      ...
      <Nav className="filters">
        <NavItem className="filters__nav-item">
          <NavLink
            onClick={() => setTab("home")}
            className={
              tab === "home" ? "filters__link--active" : "filters__link"
            }
          >
            Home
          </NavLink>
        ...
        <NavItem className="filters__nav-item">
          <NavLink
            ...
            className={
              tab === "featured" ? "filters__link--active" : "filters__link"
            }
          >
            Featured
          </NavLink>
        ...
        <NavItem className="filters__nav-item">
          <NavLink
            ...
            className={
              tab === "popular" ? "filters__link--active" : "filters__link"
            }
          >
            Most Popular
          </NavLink>
        ...
        <NavItem className="filters__nav-item">
          <NavLink
            onClick={() => setTab("last")}
            className={
              tab === "last" ? "filters__link--active" : "filters__link"
            }
          >
            Last Releases
          </NavLink>
        ...
        <TabPane tabId="home">
          <CardDeck>
            {Object.keys(resolversJson).map((resolver) => (
              <DappPreview key={resolver} id={resolver} added={false} legacy />
            ))}
          </CardDeck>
        </TabPane>
