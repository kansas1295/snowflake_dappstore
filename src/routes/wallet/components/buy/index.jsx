  ...
  return (
    <Card className="buy">
      <Row className="buy__header">
        <Col xs="10">
          <p className="buy__title mb-0">Buy and Deposit to dApp wallet</p>
        </Col>
      ...
      <Row>
        <Col className="text-center">
          <p className="buy__amount">
            10,000
            <span className="buy__hydro">Hydro</span>
          </p>
          <p className="buy__test-tokens">Get free Hydro test tokens</p>
        </Col>
      </Row>
