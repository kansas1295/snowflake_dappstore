...
const config = {
  general: {
    ...
    dappStoreName: "Snowflake Store",
    dappStoreMetaKeywords:
      "dapps, dapp store, app store, decentralized applications, decentralized apps, snowflake, hydro dapp store",
    dappStoreMetaDescription:
      "Snowflake Store store featuring decentralized applications powered by Snowflake.",
    ...
    theme: {
      //******** Settings pertaining to the stores theme. ********//
  ...
  homepage: {
    //******** Settings pertaining to the homepage. ********//
    heroCarousel: {
      //******** Settings pertaining to the hero carousel on the homepage. ********//
    ...
    dapps: {
      //******** Settings pertaining to the dApps on the homepage. ********//
  ...
  dappSingleLandingPage: {
    //******** Settings pertaining to a single dApp landing page. ********//
    general: {
      //******** General settings on a single dapp landing page. *******//
    ...
    additional: {
      //******** Additional settings on a single dapp landing page. *******//
    ...
    social: {
      //******** Social icons on a single dapp landing page. *******//
  ...
  dappCategories: {
    //******** Settings pertaining to dApp categories in the main sidebar. ********//
    categories: [
      {
    ...
    items: [
      {
        ...
        title: "Get Involved",
        description:
          "Are you a developer? Do you have a dApp idea? Do you want to partner with us?",
    ...
    items: [
      {
        ...
        answer:
          "It is about this and that. It also has a lot to do with x, y and z.",
        category: "general",
        active: true,
      },
      {
